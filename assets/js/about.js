...
document.addEventListener("DOMContentLoaded", () => {
  const sliderImages = [
    "assets/images/global-slider/1.webp",
    "assets/images/global-slider/2.webp",
    "assets/images/global-slider/3.webp",
  ];
  ...
  if (slicedSlider) {
    ...
    setInterval(() => {
      ...
      slicedSlider.style.backgroundImage = `url(${sliderImages[sliderIndex]})`;
    }, 6000);
  }
});
