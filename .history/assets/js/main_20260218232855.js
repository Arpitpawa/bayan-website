...
/* =========================================
   SPOTLIGHT SLIDER – PREMIUM SMOOTH VERSION
========================================= */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* AUTO SLIDE – SLOW & LUXURY */
  setInterval(() => {
    currentIndex++;
    if (currentIndex >= totalSlides) currentIndex = 0;
    updateSlider();
  }, 8500); // slower interval

});
/* ===============================
   SPOTLIGHT SLIDER (ISOLATED)
================================ */
