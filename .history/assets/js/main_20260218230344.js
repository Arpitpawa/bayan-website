...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const nextBtn = document.querySelector(".spotlight-btn.right");
  const prevBtn = document.querySelector(".spotlight-btn.left");
  ...
  function updateSlider() {
    ...
    track.style.transform = `translateX(-${offset - 120}px)`;
  }
