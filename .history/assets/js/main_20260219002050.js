...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const guestBox = document.querySelector(".lux-guests");

if (guestToggle && guestBox) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showVoice(i) {
    voices.forEach((v) => v.classList.remove("active"));
    dots.forEach((d) => d.classList.remove("active"));

    voices[i].classList.add("active");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const closeBtn = document.getElementById("luxPopupClose");
...
/* =========================================
   SPOTLIGHT SLIDER – CLEAN MOBILE VERSION
========================================= */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateSlider() {
    track.style.transition = "transform 0.8s cubic-bezier(0.77,0,0.18,1)";
...
const guestToggle = document.getElementById("guestToggle");
const guestDropdown = document.getElementById("guestDropdown");
const guestWrapper = document.querySelector(".lux-guests");

guestToggle.addEventListener("click", () => {
  guestWrapper.classList.toggle("open");
});

document.addEventListener("click", (e) => {
  if (!guestWrapper.contains(e.target)) {
    guestWrapper.classList.remove("open");
  }
});
