...
cursorZone.addEventListener("mousemove", (e) => {
  ...
  cursorIndicator.style.left = centerX + "px";
  cursorIndicator.style.top = centerY + "px";
  ...
  // RIGHT EDGE
  else if (x > rect.width - threshold && currentIndex < totalItems - 1) {
...
function hideCursor() {
  ...
  // ===========================================
  cursorZone.addEventListener("click", (e) => {
